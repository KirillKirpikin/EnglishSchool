(() => {
    ...
    function initSliders() {
        if (document.querySelector(".reviews-section__slider")) new core(".reviews-section__slider", {
            modules: [ Navigation ],
            observer: true,
            observeParents: true,
            slidesPerView: 2.5,
            ...
            speed: 800,
            navigation: {
                prevEl: ".reviews-section__arrow_left",
                nextEl: ".reviews-section__arrow_right"
            },
            breakpoints: {
                320: {
                    slidesPerView: 1.01,
